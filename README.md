...
dependencies {
	    compile 'com.github.raxden:AndroidResources:3.0.4@aar'
}
```
...
For a **detailed documentation**, please have a look at the [**Wiki**](https://github.com/raxden/AndroidResources/wiki) or the [**Javadocs**](https://jitpack.io/com/github/raxden/AndroidResources/3.0.4/javadoc/).
